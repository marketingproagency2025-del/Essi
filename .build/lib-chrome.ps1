...
# The 36 page slugs, identical in every language tree. 'index' is the tree root.
$PAGES = @(
  ...
  'blog-windows-and-doors', 'blog-stoves-and-heating', 'blog-builders', 'blog-restaurants',
  'article-1', 'article-2',
...
$PRIORITY = @{
  ...
  'blog-windows-and-doors' = '0.7'; 'blog-stoves-and-heating' = '0.7'; 'blog-builders' = '0.7'; 'blog-restaurants' = '0.7'
